...
@Entity
@Table(name="BOOKS")
public class Book<L extends Collection<E>> {
	...
	public Book(String title, String author, int releaseYear, int edition ,String category) {
		super();
		this.title = title;
		this.author = author;
	...
	public Book(String code_complete, String steve_mcConnell, int i, int i1) {
	}
