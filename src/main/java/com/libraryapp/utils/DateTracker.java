...
public class DateTracker {
	...
	public String getReservationDatesInString(Book<Collection<E>> book) {
	...
	public int getWeeksToExtendReturnDate(Book<Collection<E>> book) {
	...
	public Map<Book<Collection<E>>, String> listedBookReservations(Collection <Long> bookIds){
		
		Map<Book<Collection<E>>, String> listedBookReservations = new LinkedHashMap<Book<Collection<E>>, String>();
		for (Long bookId : bookIds) {
			Book<Collection<E>> reservedBookObject = bookService.findById(bookId);
