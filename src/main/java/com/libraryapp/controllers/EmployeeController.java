...
public class EmployeeController {
	...
	ListInStringConverter listConverter;
		...
		public String newBook(Model model) {
			model.addAttribute("book", new Book<Collection<E>>());
			return "employee/employee-new-book.html";
		}
		
		@PostMapping(value="/books/save")
		public String saveBook(Book<Collection<E>> book) {
		...
		public String areYouSureToDeleteBook(@RequestParam Long deleteBookId, Model model) {
			Book<Collection<E>> book = bookService.findById(deleteBookId);
		...
		public String changeBookInfo(@RequestParam Long changeBookId, Model model) {
			Book<Collection<E>> book = bookService.findById(changeBookId);
		...
		public String orders(@RequestParam (required = false) String firstName,
			...
			List<Book<Collection<E>>> searchedBooks = bookService.searchBooks(title, author);
			...
			List<Book<Collection<E>>> selectedBookObjects = bookService.convertIdsCollectionToBooksList(selectedBookIds);
		...
		public String confirmOrder(@RequestParam String selectedBookIdsInString,
			...
			List<Book<Collection<E>>> selectedBooks = bookService.convertIdsCollectionToBooksList(selectedBookIds);
			User user = usService.findById(userId);
		...
		public String returnedBooks(@RequestParam (required = false) Long userId,
			...
			LinkedHashMap<Book<Collection<E>>, BigDecimal> booksInUseByUser = null;
			...
			LinkedHashMap<Book<Collection<E>>, BigDecimal> selectedBooks = fineCalculator.getBooksWithFines(bookService.convertIdsCollectionToBooksList(selectedBookIds));
		...
		public String saveReturnedBooks(@RequestParam String selectedBookIdsInString) {
			...
			List<Book<Collection<E>>> books = bookService.convertIdsCollectionToBooksList(returnedBooks);
		...
		public String updateBookReservation(@RequestParam Long bookId,
			...
			Book<Collection<E>> book = bookService.findById(bookId);
